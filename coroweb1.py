...
class RequestHandler(object):
    ...
    def __init__(self, app, fn):
        self._app = app
        self._func = fn
        self._has_request_kw_arg = has_request_kw_args(fn)
    ...
    async def __call__(self, request):
        kw = None
        if self._has_named_kw_args or self._has_var_kw_args or self._get_required_kw_args :
        ...
        if kw is None:
            ...
            if not self._has_var_kw_args and self._has_named_kw_args:
                copy = dict()
                for name in self.get_named_kw_args:
                    if name in kw:
                        copy [name] = kw[name]
                kw = copy
